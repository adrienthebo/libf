...
BOOST_AUTO_TEST_CASE( test_rm_no_subtrees ) {
    std::cout << "Testing rm_no_subtrees()" << std::endl;
...
BOOST_AUTO_TEST_CASE( test_rm_right_subtree ) {
    std::cout << "Testing rm_right_subtree()" << std::endl;
...
BOOST_AUTO_TEST_CASE( test_rm_left_subtree ) {
    std::cout << "Testing rm_left_subtree()" << std::endl;
...
BOOST_AUTO_TEST_CASE( test_rm_both_subtrees) {
    std::cout << "Testing rm_both_subtrees()" << std::endl;
...
BOOST_AUTO_TEST_CASE( test_core_fail) {
    std::cout << "WARNING: test_core_fail not implemented." << std::endl;
}
...
BOOST_AUTO_TEST_CASE( test_duplicate_keys) {
    ...
    std::cout << "WARNING: test_duplicate_keys not implemented." << std::endl;
}
